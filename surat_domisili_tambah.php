<?php
	...
	if (!isset($_POST['xsubmit'])) {
		...
		echo "<meta http-equiv='refresh' content='0;surat_domisili.php?go=administrasi'>";
		return;
	}
    ...
    mysqli_stmt_prepare($stmt_insert, "INSERT INTO tbl_surat_domisili (id_penduduk, status_pengajuan) VALUES (?, ?)");
