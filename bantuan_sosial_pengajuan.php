...
<body>
      ...
      <div class="container contact">
        <div class="row">
          <div class="col-6 mb-4">
            <h4><i class="bx bx-file me-2"></i>Data Pengajuan</h4>
          </div>
            ...
            <tbody>
              ...
              ?>
                ...
                <tr>
                  ...
                  <td><?= ucfirst($bantuan_sosial['tipe_bantuan']) ?></td>
                  <td>
  ...
  <!--============================= MODAL INPUT BANTUAN SOSIAL =============================-->
  <div class="modal fade" id="ModalInputBantuanSosial" tabindex="-1" role="dialog" aria-labelledby="ModalInputBantuanSosialTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="ModalInputBantuanSosialTitle">Modal title</h5>
          <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form>
          <div class="modal-body">
  ...
  <script>
    $(document).ready(function() {
      ...
      const selectTipeBantuan = $('#xtipe_bantuan')

      initSelect2(selectTipeBantuan, {
        width: '100%',
        dropdownParent: "#ModalInputBantuanSosial .modal-content .modal-body"
      });
      ...
      $('.toggle_modal_tambah').on('click', function() {
        $('#ModalInputBantuanSosial .modal-title').html(`<i data-feather="plus-circle" class="me-2 mb-1"></i>Pengajuan Pengajuan Bantuan Sosial`);
        $('#ModalInputBantuanSosial form').attr({action: 'bantuan_sosial_pengajuan_tambah.php', method: 'post'});

        // Re-init all feather icons
        feather.replace();
        
        $('#ModalInputBantuanSosial').modal('show');
      });
      ...
      const formElement = $('#ModalInputBantuanSosial form');
      const submitElement = $('<input />')
        .attr('type', 'hidden')
        .attr('name', 'xsubmit')
        .attr('value', 'Pengajuan Bantuan Sosial Baru');
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.toggle_modal_cari_by_nik').on('click', function() {
        $('#ModalCariByNik .modal-title').html(`<i data-feather="info" class="me-2 mb-1"></i>Cari Pengajuan Pengajuan Bantuan Sosial`);
      ...
      $('#xnik_filter_btn').on('click', function() {
        ...
        $.ajax({
          url: 'get_bantuan_sosial_by_nik.php',
          method: 'POST',
          data: {
            nik: nik_filter
          },
