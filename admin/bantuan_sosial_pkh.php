...
?>
  ...
  <head>
    ...
    <meta name="description" content="Data Bantuan Sosial PKH" />
    <meta name="author" content="" />
    <title>Bantuan Sosial PKH - <?= SITE_NAME ?></title>
  </head>
  ...
  <body class="nav-fixed">
          ...
          <div class="container-xl px-4 mt-5">
            ...
            <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
              <div class="me-4 mb-3 mb-sm-0">
                <h1 class="mb-0">Bantuan Sosial PKH</h1>
                <div class="small">
            ...
            <div class="card card-header-actions mb-4 mt-5">
              <div class="card-header">
                <div>
                  <i class="bx bx-wallet" style="font-size: 1rem"></i>
                  Data Bantuan Sosial PKH
                </div>
    ...
    <div class="modal fade" id="ModalInputPengajuanBantuanSosialPKH" tabindex="-1" role="dialog" aria-labelledby="ModalInputPengajuanBantuanSosialPKHTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="ModalInputPengajuanBantuanSosialPKHTitle">Modal title</h5>
            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <form>
            <div class="modal-body">
    ...
    <script>
      $(document).ready(function() {
        ...
        const modalInputSuratDomisiliSelect = $('#ModalInputPengajuanBantuanSosialPKH .select2');

        initSelect2(modalInputSuratDomisiliSelect, {
          width: '100%',
          dropdownParent: '#ModalInputPengajuanBantuanSosialPKH .modal-content .modal-body'
        });
        

        $('.toggle_modal_tambah').on('click', function() {
          $('#ModalInputPengajuanBantuanSosialPKH .modal-title').html(`<i data-feather="plus-circle" class="me-2 mt-1"></i>Tambah Bantuan Sosial PKH`);
          $('#ModalInputPengajuanBantuanSosialPKH form').attr({action: 'bantuan_sosial_pkh_tambah.php', method: 'post'});

          // Re-init all feather icons
          feather.replace();
          
          $('#ModalInputPengajuanBantuanSosialPKH').modal('show');
        });
        ...
        $('.datatables').on('click', '.toggle_modal_ubah', function() {
          ...
          $('#ModalInputPengajuanBantuanSosialPKH .modal-title').html(`<i data-feather="edit" class="me-2 mt-1"></i>Ubah Bantuan Sosial PKH`);
          $('#ModalInputPengajuanBantuanSosialPKH form').attr({action: 'bantuan_sosial_pkh_ubah.php', method: 'post'});

          $('#ModalInputPengajuanBantuanSosialPKH #xid_bantuan_sosial').val(data.id_bantuan_sosial);
          $('#ModalInputPengajuanBantuanSosialPKH #xid_penduduk').val(data.id_penduduk).trigger('change');
          $('#ModalInputPengajuanBantuanSosialPKH #xstatus_pengajuan').val(data.status_pengajuan).trigger('change');
          $('#ModalInputPengajuanBantuanSosialPKH #xketerangan_pengajuan').val(data.keterangan_pengajuan);
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              Swal.fire({
                ...
                window.location = `bantuan_sosial_pkh_hapus.php?xid_bantuan_sosial=${id_bantuan_sosial}`;
              });
            }
          });
        });
