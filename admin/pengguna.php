          ...
          <div class="container-xl px-4 mt-5">
            ...
            <div class="card card-header-actions mb-4 mt-5">
              <div class="bg-gray-100 rounded p-3 border border-primary">
                ...
                <p class="small mb-0">Pengguna dengan hak akses <span class="text-danger">kepala_desa</span> hanya untuk <span class="text-danger">membedakan</span> kepala_desa dan kepala sekolah. Kepala Desa saat ini <span class="text-danger">tidak memiliki</span> halamannya sendiri.</p>
              </div>
            </div>
