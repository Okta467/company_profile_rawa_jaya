<?php
    ...
    mysqli_stmt_prepare($stmt, "INSERT INTO tbl_surat_keramaian (id_penduduk, perihal, status_pengajuan, keterangan_pengajuan) VALUES (?, ?, ?, ?)");
    mysqli_stmt_bind_param($stmt, 'isss', $id_penduduk, $perihal, $status_pengajuan, $keterangan_pengajuan);
