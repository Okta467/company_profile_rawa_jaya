<?php
    ...
    try {
        ...
        mysqli_stmt_bind_param($stmt_kepala_desa, 'iiiiisssssii', $id_jabatan, $id_pangkat_golongan, $id_pendidikan, $id_jurusan, $nip, $nama_kepala_desa, $jk, $alamat, $tmp_lahir, $tgl_lahir, $tahun_ijazah, $id_kepala_desa);
