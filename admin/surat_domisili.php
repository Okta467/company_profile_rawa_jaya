...
?>
  ...
  <head>
    ...
    <meta name="description" content="Data Surat Domisili" />
    <meta name="author" content="" />
    <title>Surat Domisili - <?= SITE_NAME ?></title>
  </head>
  ...
  <body class="nav-fixed">
          ...
          <div class="container-xl px-4 mt-5">
            ...
            <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
              <div class="me-4 mb-3 mb-sm-0">
                <h1 class="mb-0">Surat Domisili</h1>
                <div class="small">
    ...
    <div class="modal fade" id="ModalInputSuratDomisili" tabindex="-1" role="dialog" aria-labelledby="ModalInputSuratDomisiliTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="ModalInputSurat DomisiliTitle">Modal title</h5>
            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <form>
            <div class="modal-body">
              
              <input type="hidden" id="xid_surat_domisili" name="xid_surat_domisili">
    ...
    <script>
      $(document).ready(function() {
        ...
        $('.toggle_modal_tambah').on('click', function() {
          $('#ModalInputSuratDomisili .modal-title').html(`<i data-feather="plus-circle" class="me-2 mt-1"></i>Tambah Surat Domisili`);
        ...
        $('.datatables').on('click', '.toggle_modal_ubah', function() {
          ...
          $('#ModalInputSuratDomisili .modal-title').html(`<i data-feather="edit" class="me-2 mt-1"></i>Ubah Surat Domisili`);
          $('#ModalInputSuratDomisili form').attr({action: 'surat_domisili_ubah.php', method: 'post'});

          $('#ModalInputSuratDomisili #xid_surat_domisili').val(data.id_surat_domisili);
        ...
        $('.datatables').on('click', '.toggle_swal_hapus', function() {
          const id_surat_domisili = $(this).data('id_surat_domisili');
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              Swal.fire({
                ...
                window.location = `surat_domisili_hapus.php?xid_surat_domisili=${id_surat_domisili}`;
              });
            }
          });
        });
          ...
          { data: 'tgl_pengajuan' },
          {
            ...
            render: function ( data, type, row ) {
              return `<button class="btn btn-datatable btn-icon btn-transparent-dark me-2 toggle_modal_ubah"
                  data-id_surat_domisili="${data.id_surat_domisili}"
