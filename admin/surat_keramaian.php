...
?>
  ...
  <head>
    ...
    <meta name="description" content="Data Surat Keramaian" />
    <meta name="author" content="" />
    <title>Surat Keramaian - <?= SITE_NAME ?></title>
  </head>
  ...
  <body class="nav-fixed">
          ...
          <div class="container-xl px-4 mt-5">
            ...
            <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
              <div class="me-4 mb-3 mb-sm-0">
                <h1 class="mb-0">Surat Keramaian</h1>
                <div class="small">
    ...
    <div class="modal fade" id="ModalInputSuratDomisili" tabindex="-1" role="dialog" aria-labelledby="ModalInputSuratDomisiliTitle" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="ModalInputSurat KeramaianTitle">Modal title</h5>
            <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <form>
            <div class="modal-body">
              
              <input type="hidden" id="xid_surat_keramaian" name="xid_surat_keramaian">
              ...
              <div class="mb-3">
                <label class="small mb-1" for="xperihal">Perihal <span class="text-danger">*</span></label>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('.toggle_modal_tambah').on('click', function() {
          $('#ModalInputSuratDomisili .modal-title').html(`<i data-feather="plus-circle" class="me-2 mt-1"></i>Tambah Surat Keramaian`);
          $('#ModalInputSuratDomisili form').attr({action: 'surat_keramaian_tambah.php', method: 'post'});
        ...
        $('.datatables').on('click', '.toggle_modal_ubah', function() {
          ...
          $('#ModalInputSuratDomisili .modal-title').html(`<i data-feather="edit" class="me-2 mt-1"></i>Ubah Surat Keramaian`);
          $('#ModalInputSuratDomisili form').attr({action: 'surat_keramaian_ubah.php', method: 'post'});

          $('#ModalInputSuratDomisili #xid_surat_keramaian').val(data.id_surat_keramaian);
          $('#ModalInputSuratDomisili #xid_penduduk').val(data.id_penduduk).trigger('change');
          $('#ModalInputSuratDomisili #xperihal').val(data.perihal);
          $('#ModalInputSuratDomisili #xstatus_pengajuan').val(data.status_pengajuan).trigger('change');
          $('#ModalInputSuratDomisili #xketerangan_pengajuan').val(data.keterangan_pengajuan);
        ...
        $('.datatables').on('click', '.toggle_swal_hapus', function() {
          const id_surat_keramaian = $(this).data('id_surat_keramaian');
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              Swal.fire({
                ...
                window.location = `surat_keramaian_hapus.php?xid_surat_keramaian=${id_surat_keramaian}`;
              });
            }
          });
        });
    ...
    <script>
      ...
      let table = new DataTable('.datatables', {  
        ajax: `<?= base_url_return('admin/get_all_surat_keramaian.php') ?>`,
        order: [],
        scrollX: true,
        columns: [
          {
          ...
          { data: 'nama_lengkap' },
          {
            ...
            render: function ( data, type, row ) {
              return `<div class="ellipsis toggle_tooltip" title="${data.perihal}">${data.perihal}</div></td>`;
            }
          },
          {
            data: null,
          ...
          { data: 'tgl_pengajuan' },
          {
            ...
            render: function ( data, type, row ) {
              return `<button class="btn btn-datatable btn-icon btn-transparent-dark me-2 toggle_modal_ubah"
                  data-id_surat_keramaian="${data.id_surat_keramaian}"
