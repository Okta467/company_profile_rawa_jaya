  ...
  <body class="nav-fixed">
    ...
    <script>
      $(document).ready(function() {
        ...
        $('#xcetak_laporan').on('click', function() {
          ...
          const url = `laporan_bantuan_sosial_pkh.php?dari_tanggal=${dari_tanggal}&sampai_tanggal=${sampai_tanggal}`;
    ...
    <script>
      ...
      let table = new DataTable('.datatables', {  
        ajax: {
          url: `<?= base_url_return('kepala_desa/get_all_bantuan_sosial.php') ?>`,
          method: 'POST',
