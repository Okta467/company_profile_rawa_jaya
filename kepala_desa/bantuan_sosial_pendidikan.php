        ...
        <main>
          ...
          <div class="container-xl px-4 mt-5">
            ...
            <div class="card card-header-actions mb-4 mt-5">
              <div class="card-header">
                <div>
                  <i class="bx bx-book-reader" style="font-size: 1rem"></i>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('#xcetak_laporan').on('click', function() {
          ...
          const url = `laporan_bantuan_sosial_pendidikan.php?dari_tanggal=${dari_tanggal}&sampai_tanggal=${sampai_tanggal}`;
