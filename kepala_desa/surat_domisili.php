  ...
  <body class="nav-fixed">
    ...
    <script>
      $(document).ready(function() {
        ...
        $('#xcetak_laporan').on('click', function() {
          ...
          const url = `laporan_surat_domisili.php?dari_tanggal=${dari_tanggal}&sampai_tanggal=${sampai_tanggal}`;
    ...
    <script>
      ...
      let table = new DataTable('.datatables', {  
        ajax: `<?= base_url_return('kepala_desa/get_all_surat_domisili.php') ?>`,
        order: [],
        scrollX: true,
        columns: [
          {
