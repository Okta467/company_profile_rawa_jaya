              ...
              <div class="card-body p-5">
                <div class="row align-items-center justify-content-between">
                  <div class="col">
                    ...
                    <p class="text-gray-700"><?= SITE_NAME ?> merupakan sistem yang bertujuan untuk mengelola data layanan administrasi, sosial, dan infrastruktur <?+ SITE_NAME_SHORT_ALTERNATIVE ?>.</p>
