    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li>Bantuan Sosial Pendidikan</li>
        </ol>
        <h2>Bantuan Sosial Pendidikan</h2>
      ...
      <div class="container contact">
        <div class="row">
          <div class="col-6 mb-4">
            <h4><i class="bx bx-file me-2"></i>Data Bantuan Sosial Pendidikan</h4>
          </div>
          ...
          <table class="table table-striped table-hover table-responsive datatables" id="tabel_bantuan_sosial" cellspacing="0" width="100%" style="font-size: 0.875rem">
            ...
            <tbody>
              ...
              $query_bantuan_sosial = mysqli_query($connection, 
                ...
                WHERE a.tipe_bantuan = 'pendidikan'
                ORDER BY a.id DESC");
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.toggle_modal_cari_by_nik').on('click', function() {
        $('#ModalCariByNik .modal-title').html(`<i data-feather="info" class="me-2 mb-1"></i>Cari Pengajuan Bantuan Sosial Pendidikan`);
