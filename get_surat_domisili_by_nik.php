<?php
    ...
    "SELECT
        ...
        b.id AS id_surat_domisili, b.status_pengajuan, b.keterangan_pengajuan, b.created_at AS tgl_pengajuan
    FROM tbl_penduduk AS a
    LEFT JOIN tbl_surat_domisili AS b
    ...
    echo json_encode($surat_domisilis);
    return;
?>